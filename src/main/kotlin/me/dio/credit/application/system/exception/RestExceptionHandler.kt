...
class RestExceptionHandler {
    ...
    fun handlerValidDataException(ex: DataAccessException): ResponseEntity<ExceptionDetails> {
        return ResponseEntity(
            ExceptionDetails(
    ...
    fun handlerValidDataException(ex: BusinessException): ResponseEntity<ExceptionDetails> {
        return ResponseEntity(
            ExceptionDetails(
                title = "Bad Request! Consult documentation",
                timestamp = LocalDateTime.now(),
